    ...
    return (
        <nav
            className={cn(
                ...
                isShow || pathname == "/" ? "text-slate-800" : "text-slate-300"
            )}
        >
            <motion.div
                className="absolute left-0 top-0 bg-white/90 backdrop-blur-md origin-top w-full h-full -z-10 shadow-lg"
                initial={{ opacity: 0 }}
            ...
            <Button
                ...
                variant={isShow || pathname == "/" ? "default" : "ghost"}
                asChild
            >
